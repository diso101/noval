...
namespace Novel\CustomGrid\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_novel_customgrid_items');
        /** @var \Magento\Framework\Data\Form $form */
        $form = $this->_formFactory->create();
        $form->setHtmlIdPrefix('item_');
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Item Information')]);
        if ($model->getId()) {
            $fieldset->addField('customgrid_id', 'hidden', ['name' => 'customgrid_id']);
        }
        $fieldset->addField(
            'title',
            'text',
